...
This folder distills a research process from a high-randomness prediction project into a set of documents and templates that can be reused for **any field** involving: prediction, decision-making under uncertainty, hypothesis testing, or evaluating a strategy before betting money/time/reputation on it.
...
6. **When you hit "this can't be predicted"**: [method/05-reframing-pivot.md](method/05-reframing-pivot.md) shows how to pivot from "prediction" to "structured exploration / conscious entertainment / coverage" while keeping the work valuable.
...
- Finish a research effort → update `case-study/` with new lessons.
